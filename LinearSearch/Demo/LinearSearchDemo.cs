...
namespace demo
{
	public class LinearSearchDemo
	{
		public static void Main(string[] args)
		{
			...
			Console.WriteLine($"Salary after 4 year using Recursion is {bai21Recursion.calSalary(10000, 5)}");
			Console.WriteLine($"Salary after 4 year is {bai21Recursion.calculateSalary(10000, 5)}");
